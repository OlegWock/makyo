...
if (!process.env.MAKYO_DB_PATH) {
  console.error('You must set MAKYO_DB_PATH env variable');
  process.exit(1);
}
...
const sqlite = new Database(resolve(process.cwd(), process.env.MAKYO_DB_PATH));
